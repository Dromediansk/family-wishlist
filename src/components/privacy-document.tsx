...
/**
 * The privacy policy's shape. Rendered by `/privacy` and by `/en/privacy`,
 * which differ only in the language the request pins and the `alternates` each
 * one declares. docs/decisions/language.md#the-public-pages-pin-their-locale
 *
